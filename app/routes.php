...
Route::get('testBelongsTo', function(){
	$model = Book::all(); // **Book::all คือการดึงข้อมูลมาทั้งหมดจากตาราง book
...
/*
Read การอ่านข้อมูลจากฐานข้อมูล คือ เป็นการดึงข้อมูลขึ้นมาแสดงเหมือนการ SELECT เพียงแต่ว่าไม่ต้องเขียน SQL เองให้เหนื่อย
*/
//Test Read
Route::get('read', 'ExamModelController@read');

/*
Update การแก้ไข คือ เป็นการเปลี่ยนแปลงข้อมูลที่มีอยู่แล้วใหม่หรือการแก้ไขข้อมูลนั่นเอง
*/
//Test Update
...
/*
การใช้งาน Pagination คือ เป็นการแบ่งข้อมูลเป็นหน้าแยกกันตามปริมาณข้อมูล  
*/
//Test Pagination
Route::get('myPagination', 'ExamModelController@myPagination');

/*
การใช้งาน DB::select กรณีที่ต้องการ query เงื่อนไขยากๆ ก็จะใช้ตัวนี้แทน 
*/
//Test DB::select
